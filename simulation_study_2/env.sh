...
export SIMULATION_STUDY_SCRIPT_PATH="/gpfs/home/susmah01/targeted_msms_paper/simulation_study_2/simstudy.R"

# Path to cache folder for temporary results
export SIMULATION_CACHE_PATH="/gpfs/scratch/susmah01/targeted_msms_paper/cache_2"

# Path to log folder
export SIMULATION_LOG_PATH="/gpfs/scratch/susmah01/targeted_msms_paper/logs_2"

# Path to results folder for final results
export SIMULATION_RESULTS_PATH="/gpfs/home/susmah01/targeted_msms_paper/simulation_study_2/results"
...
export ARRAY=5,6,7,13,15,19,20 # Array indexes to run
